...
function createBalls() {
    for (let index = 0; index < randNum(10, 13); index++) {
        ...
        div.style.animation = `div 4s linear infinite,${animationClasses[randNum(0, 8)]} ${randNum(5, 9)}s linear ${randNum(0, 2)}s infinite ${randNum(0, 1) ? "alternate" : "alternate-reverse"}`;
